...
// Os dados de uma stream são lazy evaluation (sob demanda), serão consumidos somente quando necessários.
// Só pode usada uma vez (single-use).
// Pipeline - Linha de montagem. Operações em streams retornam novas streams. 
// Então é possivel criar uma cadeia de operações
